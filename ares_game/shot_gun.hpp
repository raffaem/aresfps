...
*/
#pragma once
#ifndef MANCUSO_RAFFAELE_ARES_SHOT_GUN_79804695106987069406987409
#define MANCUSO_RAFFAELE_ARES_SHOT_GUN_79804695106987069406987409

#include "weapon.hpp"
class shot_gun_class:public weapon_class {
public:
	void Load();
};
