...
#include "evar.hpp"
void punch_gun_class::Load() {
	//MACHINE GUN
	scene::IAnimatedMesh* machine_gun_file=smgr->getMesh("media\\models\\punch_gun.md2");
	this->ogg=(raf::OGGETTOANIMATO)smgr->addAnimatedMeshSceneNode(machine_gun_file); 
	this->ogg->setMaterialTexture(0,driver->getTexture("media\\texture\\punch_gun.jpg")); 
	//PER LE COLLISIONI
	...
	this->ammunation=0;
	this->infinite_munition=true;
	this->damage=2;
	this->machine_gun_style=false;
	this->type=PUNCH_GUN;
	this->sound_shoot=&sound.rifle;
	this->texture_file="media\\texture\\punch_gun.jpg";
	//TO ACTIVE
