...
#include "evar.hpp"
void machine_gun_class::Load() {
	//MACHINE GUN
	scene::IAnimatedMesh* machine_gun_file=smgr->getMesh("media\\models\\machine_gun.md2");
	this->ogg=(raf::OGGETTOANIMATO)smgr->addAnimatedMeshSceneNode(machine_gun_file); 
	this->ogg->setMaterialTexture(0,driver->getTexture("media\\texture\\machine_gun.jpg")); 
	//PER LE COLLISIONI
	...
	this->ogg->setMD2Animation("scene");

	this->ammunation=0;
	this->damage=4;
	this->machine_gun_style=true;
	this->type=MACHINE_GUN;
	this->sound_shoot=&sound.sparo_di_mitragliatrice;
	this->texture_file="media\\texture\\machine_gun.jpg";
	//TO ACTIVE
