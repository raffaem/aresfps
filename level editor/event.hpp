...
*/
#pragma once
#ifndef MANCUSO_RAFFAELE_ARES_LEVEL_EDITOR_EVENT_HPP_87168435373512300894260
#define MANCUSO_RAFFAELE_ARES_LEVEL_EDITOR_EVENT_HPP_87168435373512300894260

#include <string>
#include <irrlicht.h>
class MyEventReceiver:public IEventReceiver {
public:
	virtual bool OnEvent(irr::SEvent irrevent);
};
