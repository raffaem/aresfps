...
*/
#pragma once
#ifndef MANCUSO_RAFFAELE_ARES_LEVEL_EDITOR_SAVE_HPP_04894709514219874690436840869840
#define MANCUSO_RAFFAELE_ARES_LEVEL_EDITOR_SAVE_HPP_04894709514219874690436840869840
#include <string>

std::string Save(std::string script_file_s="");
